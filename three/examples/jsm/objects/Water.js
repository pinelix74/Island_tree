 ...
 */
	...
	class Water extends THREE.Mesh {
		...
		constructor( geometry, options = {} ) {
			...
			const alpha = options.alpha !== undefined ? options.alpha : 0.8;
			...
			const mirrorShader = {
				uniforms: THREE.UniformsUtils.merge( [ THREE.UniformsLib[ 'fog' ], THREE.UniformsLib[ 'lights' ], {
					...
					'depthOpacityScale': {
						value: 1 // Adjust this value to control depth transparency
					}
				} ] ),
				vertexShader:
      /* glsl */
      ...
      `
			...
			const material = new THREE.ShaderMaterial( {
				...
				opacity: alpha, // Set desired opacity
				fog: fog
			} );
			...
			material.blendFunc = THREE.SrcAlphaFactor; // This is default, but good to verify
